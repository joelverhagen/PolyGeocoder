...
namespace Knapcode.PolyGeocoder.Test
{
    public class BingGeocoderTest
    {
        ...
        public async Task Integration()
        {
            ...
            var target = new BingGeocoder(client, Configuration.BingMapsApiKey);
            ...
            Assert.Equal("1600 Pennsylvania Ave NW, Washington, DC 20500", location.Locations[0].Name);
